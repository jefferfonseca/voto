...
//Se valida que sea superadministrador para que pueda agregar o modificar estudiantes
        if ($_COOKIE['VotaDatAdmin'] == 1) {
            ...
            if (isset($_POST['envia_estudiante'])) {
                ...
                if ($duplica == 1) {
                    include_once "encabezado.html";
                    print "<strong>Ya existe un estudiante con este número
 de documento<br />";
                    print "<br /><a href='javascript:history.go(-1)'>Volver al formulario</a></strong></div></body></html>";
                    exit;
                }
            ...
            if ((isset($_GET['agrega'])) and ($_GET['agrega'] == "ok")) {
                ...
                echo '</label></td>';
                echo '<td><input type="text" name="doc_est" size="30" maxlength="50" title="Escriba el número
 de documento del estudiante" />';
                ...
                echo '</label></td>';
                echo '<td><input type="password" name="clave_est" size="30" maxlength="50" title="Escriba la contraseña
