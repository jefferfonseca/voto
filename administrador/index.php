...
" rel="stylesheet" type="text/css" />';
		...
		echo '<tr><td><a href="javascript:NuevaVentana(\'cambiarclave.php?id='.md5($row['id']).'\')" title="Cambiar contraseña
 de acceso"><img src="../iconos/clave.png" border="0" alt="Clave" /> Cambiar contraseña
</a></td></tr>';
